...
var makeRandomPizza = function() {
  ...
  // replace with the following 3 loops with one
  ...
  // loop through only one time to build pizza
...
function updatePositions() {
  ...
  var scrollCalc = Math.sin(document.body.scrollTop / 1250); // moved this calculation out of for loop below
